		...
		if($this->session->userdata('role')=='developer'){
			...
			if($check_email>0){
				...
				$config = array(
				            ...
				            'smtp_port' => 465, 
				            'smtp_user' => 'mediummyofficial@gmail.com', 
				...
				$directory = base_url().'cpanel/login';

				//Email content
				$htmlContent = '<h1>Hi '.$first_name.' , congratulations you have successfully join project '.$project_name.'.</h1>';
				$htmlContent .= '<p>CPANEL : 
				<a href="'.$directory.'">
				'.$directory.'
				</a>
				...
				$this->email->to($email);
				$this->email->from('sufianmohdhassan19@gmail.com','Appku.my');
				$this->email->subject('Invitation Join Project '.$project_name.' From Appku.my');
